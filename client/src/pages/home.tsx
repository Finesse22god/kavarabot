    ...
    <div className="relative h-screen bg-black overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 p-6 pb-24">
        <div className="relative w-full border-2 border-white rounded-full overflow-hidden shadow-xl">
          ...
          <div 
            className={`absolute top-2 bottom-2 right-1/2 bg-white transition-all duration-300 ease-out rounded-l-full ${
          ...
          <div 
            className={`absolute top-2 bottom-2 left-1/2 bg-white transition-all duration-300 ease-out rounded-r-full ${
