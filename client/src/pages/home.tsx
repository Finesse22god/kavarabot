    ...
    <div className="fixed inset-0 bg-black overflow-hidden flex flex-col pt-safe">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center items-center text-center px-4 sm:px-6">
        <div className="mb-6 sm:mb-8 flex flex-col items-center">
          <h1 className="sm:text-5xl md:text-6xl font-bold text-white mb-0 leading-none tracking-widest drop-shadow-lg text-[60px] whitespace-nowrap" style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}>
            KAVARA BOX
          </h1>
